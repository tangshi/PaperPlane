    ...
    namespace Types
    {
        ...
        struct ObjectExtraData
        {
            ObjectExtraData()
            {
				...
				this->affectDiffuse = true;
				this->affectSpecular = true;
            ...
            ObjectExtraData(ObjectExtraData& other)
            {
				...
				this->affectDiffuse = other.affectDiffuse;
				this->affectSpecular = other.affectSpecular;
				this->ambientOnly = other.ambientOnly;
        ...
        struct ObjectParameters
        {
            ...
            ObjectParameters()
            {
				...
				this->queryFlagsEnabled = false;
                this->queryFlags = 0;
				this->visibilityFlagsEnabled = false;
			...
			/** Indicates whether queryFlags is used. If true, queryFlags must be something other than 0 to be used. */
			bool queryFlagsEnabled;

            /** Object query flags */
            Ogre::uint32 queryFlags;

			/** Indicates whether visibilityFlags is used. If true, visibilityFlags must be something other than 0 to be used.*/
			bool visibilityFlagsEnabled;
        ...
        struct EntityParameters : ObjectParameters
        {
            ...
            struct Subentity
            {
				Subentity()
				{
					this->renderQueuePriority = 0;
				}

                Ogre::String materialName;
				Ogre::String renderQueue;
				Ogre::ushort renderQueuePriority;
            };
